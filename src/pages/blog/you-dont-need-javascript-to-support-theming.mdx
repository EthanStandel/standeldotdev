...
title: (WIP) You don't need JavaScript to support theming
---
import { Card } from "../../components/Card";

# (WIP) You don't need JavaScript to support theming

<details>
  <summary>tl;dr</summary>
  CSS variables & `@media (prefers-color-scheme: dark)`
</details>
...
The traditional move would be that 
...
_Fig 1. This site dynamically adapting to system theme after JavaScript has been disabled._
